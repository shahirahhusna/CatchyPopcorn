...
public class StockOut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(v -> db.collection("Users").document(currentUser).get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if (document.exists()) {
                    ...
                    if ("crew".equals(role)) {
                        Intent intent = new Intent(StockOut.this, CrewDashboard.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Intent intent = new Intent(StockOut.this, ManagerDashboard.class);
                        startActivity(intent);
                        finish();
                    }
                } else {
        ...
        scan = findViewById(R.id.stockOutScan);
        stockOut = findViewById(R.id.stockOutBtn);
        product = findViewById(R.id.stockOuttext);
        quantityEditText = findViewById(R.id.quantityEditText);

        scan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IntentIntegrator intentIntegrator = new IntentIntegrator(StockOut.this);
        ...
        stockOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (productName.isEmpty() || quantityString.isEmpty()) {
                    Toast.makeText(StockOut.this, "Please enter product name and quantity", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                try {
                    ...
                    Toast.makeText(StockOut.this, "Invalid quantity", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                db.collection(collection).whereEqualTo(nameField, productName)
                        ...
                        .addOnSuccessListener(queryDocumentSnapshots -> {
                            if (queryDocumentSnapshots.isEmpty()) {
                                Toast.makeText(StockOut.this, "Product not found", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            for (DocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                                ...
                                db.collection(collection)
                                        ...
                                        .addOnSuccessListener(aVoid -> {
                                            Toast.makeText(StockOut.this, "Product quantity updated successfully!", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(StockOut.this, Inventory.class);
                                            startActivity(intent);
                                            finish();
                                        })
                                        .addOnFailureListener(e -> {
                                            Toast.makeText(StockOut.this, "Error updating product quantity: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                        });
                            }
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(StockOut.this, "Error fetching product: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
            }
        });
    }
